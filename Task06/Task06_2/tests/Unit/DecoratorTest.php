...
namespace kudryavcev\Tests;

use PHPUnit\Framework\TestCase;
use kudryavcev\Task062\EconomyRoom;
use kudryavcev\Task06_2\StandardRoom;
use kudryavcev\Task06_2\SuiteRoom;
use kudryavcev\Task06_2\InternetDecorator;
use kudryavcev\Task06_2\BreakfastDecorator;
use kudryavcev\Task06_2\FoodDeliveryDecorator;
use kudryavcev\Task06_2\SofaDecorator;
